...
MySQL - 10.4.20-MariaDB : Database - almacensoia
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`almacensoia` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `egresos` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_egresos_usuario` (`usuario`),
  CONSTRAINT `fk_egresos_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`id`)
) ENGINE=INNODB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4;

/*Data for the table `egresos` */

INSERT  INTO `egresos`(`id`,`descripcion`,`gasto`,`fecha`,`hora`,`usuario`) VALUES 
(5,'CONTADORA (junio)',50,'2021-08-20','2021-08-20 01:11:03',15),
(6,'compra de mercaderia (5unid)',88,'2021-08-27','2021-08-27 19:25:24',15),
(7,'compra de mercaderia (12unid)',120,'2021-08-29','2021-08-29 23:58:44',15),
(8,'courrier Shalom (5unid)',10,'2021-08-29','2021-08-29 23:59:29',15),
(9,'Pago a la sunat ',54,'2021-09-01','2021-09-01 11:14:30',15),
(10,'compra de mercaderia (15unid)',282,'2021-09-06','2021-09-06 00:05:56',15),
(11,'compra de mercaderia (6 unidades)',102,'2021-09-10','2021-09-10 00:16:43',15),
(12,'compra de ganchos madera (3 docenas)',68,'2021-09-10','2021-09-10 00:18:16',15),
(13,'compa de mercaderia (5 prendas)',80,'2021-09-15','2021-09-15 22:17:44',15),
(14,'bolsas kraft (peque y grandes)',200,'2021-09-15','2021-09-15 22:18:01',15),
(15,'rack para ropa promart',32,'2021-09-15','2021-09-15 22:18:21',15),
(16,'contadora (julio)',50,'2021-09-15','2021-09-15 22:18:56',15),
(17,'Alquiler feria marciana',820,'2021-09-16','2021-09-16 00:00:00',15),
(18,'Compra de mercaderia (6 prendas)',111,'2021-09-17','2021-09-17 23:33:22',15),
(19,'delivery (piura/Lima)',15,'2021-09-17','2021-09-17 23:34:10',15),
(20,'Delivery (trujillo - Cajamarca)',8.9,'2021-09-17','2021-09-17 23:35:05',15),
(21,'DELIVERY (Cajamarca - Lima)',13,'2021-09-26','2021-09-26 20:01:16',15),
(22,'CONTADORA AGOSTO ',50,'2021-10-05','2021-10-05 23:13:31',15),
(23,'Delivery (piura -trujillo)',8.9,'2021-11-24','2021-11-24 20:31:22',15),
(24,'SUNAT NOVIEMBRE',94,'2021-11-24','2021-11-24 20:32:01',15),
(25,'Delivery (Trujillo - cajamarca)',8.9,'2021-11-24','2021-11-24 20:32:38',15);


/*Table structure for table `multimarca` */

DROP TABLE IF EXISTS `multimarca`;

CREATE TABLE `multimarca` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  `usuario` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_multimarca_usuario` (`usuario`),
  KEY `FK_multimarca_provincia` (`provincia`),
  KEY `FK_multimarca_distrito` (`distrito`),
  KEY `FK_multimarca_departamentos` (`departamentos`),
  CONSTRAINT `FK_multimarca_departamentos` FOREIGN KEY (`departamentos`) REFERENCES `departamentos` (`id`),
  CONSTRAINT `FK_multimarca_distrito` FOREIGN KEY (`distrito`) REFERENCES `distritos` (`id`),
  CONSTRAINT `FK_multimarca_provincia` FOREIGN KEY (`provincia`) REFERENCES `provincias` (`id`),
  CONSTRAINT `fk_multimarca_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`id`)
) ENGINE=INNODB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4;

/*Data for the table `multimarca` */

INSERT  INTO `multimarca`(`id`,`nombre`,`provincia`,`distrito`,`departamentos`,`comision`,`usuario`) VALUES 
(22,'CENTRAL WEEK',123,1107,13,25,15),
(23,'PITANGA ',159,1442,20,20,15),
(24,'CLANDESTINA',55,519,6,30,15),
(25,'cedc',135,1237,15,3,13),
(26,'AUTENTICA',194,1674,25,30,15),
(27,'Lima',135,1237,15,0,15),
(28,'PITANGA',159,1442,20,20,16),
(29,'PITANGA',159,1442,20,20,17),
(30,'AUTENTICA',194,1674,25,30,17),
(31,'CLANDESTINA',55,519,6,30,17),
(32,'CENTRAL WEEK',123,1116,13,25,17);
...
CREATE TABLE `pedidos` (
  ...
  `hora` TIME NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_usuaro_pedido` (`usuario_id`),
  CONSTRAINT `FK_usuaro_pedido` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=INNODB AUTO_INCREMENT=155 DEFAULT CHARSET=utf8mb4;

/*Data for the table `pedidos` */

INSERT  INTO `pedidos`(`id`,`usuario_id`,`total`,`fecha`,`hora`) VALUES 
(127,15,47.6,'2021-08-20','01:05:53'),
(128,15,47.6,'2021-08-22','17:54:51'),
(129,15,73.54,'2021-09-01','11:13:11'),
(130,15,165,'2021-09-06','19:51:28'),
(131,15,193.2,'2021-09-15','22:26:30'),
(132,15,30.4,'2021-09-21','23:18:25'),
(135,15,1,'2021-09-26','22:27:35'),
(136,15,73.5,'2021-09-26','23:30:30'),
(137,15,165,'2021-09-26','23:44:22'),
(141,15,235,'2021-09-27','00:44:47'),
(142,15,48.3,'2021-10-01','21:37:42'),
(143,15,223.5,'2021-10-05','22:39:20'),
(144,15,55,'2021-10-19','22:50:10'),
(145,15,158.9,'2021-10-19','22:51:53'),
(146,15,144.41,'2021-11-02','23:47:57'),
(147,15,72.45,'2021-11-09','23:17:59'),
(148,15,17.15,'2021-11-22','14:51:37'),
(149,15,48.3,'2021-11-22','23:17:35'),
(150,15,54.88,'2021-11-24','20:30:43'),
(151,15,213.45,'2022-01-05','16:59:46'),
(152,15,193.34,'2022-01-05','23:43:17'),
(153,15,24.5,'2022-01-05','23:43:25'),
(154,15,63.21,'2022-01-07','22:46:49');
...
CREATE TABLE `producto` (
  ...
  `multimarcaid` INT(11) DEFAULT NULL,
  PRIMARY KEY (`codigo`),
  KEY `FK_categoria` (`categoria_id`),
  KEY `fk_producto_usuario` (`usuario`),
  KEY `fk_multimarca_id` (`multimarcaid`),
  CONSTRAINT `FK_categoria` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `fk_multimarca_id` FOREIGN KEY (`multimarcaid`) REFERENCES `multimarca` (`id`),
  CONSTRAINT `fk_producto_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`id`)
) ENGINE=INNODB AUTO_INCREMENT=219 DEFAULT CHARSET=utf8mb4;

/*Data for the table `producto` */

INSERT  INTO `producto`(`codigo`,`sku`,`nombre`,`usuario`,`categoria_id`,`precio_compra`,`precio_venta`,`stock`,`fecha`,`imagen`,`multimarcaid`) VALUES 
(85,'SOIA 1','Top Micca rosado',15,4,14.5,29,1,'2019-03-11','',24),
(86,'SOIA 3','Top Micca guinda',15,4,14.5,29,1,'2019-03-11','',26),
(87,'SOIA 4','Falda Micca guinda',15,6,14.5,59,1,'2019-03-11','',26),
(88,'SOIA 5','Cafarena Alura negro',15,7,24,49,1,'2019-03-11','',24),
(89,'SOIA 6','Enterizo Sofia negro',15,8,29,69,1,'2019-03-11','156813108_243772317463449_2292399997985239929_n.jpg',26),
(90,'SOIA 7','Enterizo Sofia verde ',15,8,29,69,1,'2019-03-11','157064689_243772544130093_6232841786948657473_n.jpg',26),
(91,'SOIA 8','Enterizo Sofia blanco ',15,8,29,69,1,'2019-03-11','155824873_243772210796793_2712438121046260645_n.jpg',26),
(92,'SOIA 9','Faldashort Maia rosado',15,6,28,69,1,'2019-03-11','156456602_243768064130541_7004510676470550917_n.jpg',26),
(93,'SOIA 15','Top Angel guinda',15,4,12,39,1,'2019-03-11','WhatsApp Image 2021-09-17 at 11.45.27 PM.jpeg',26),
(94,'SOIA 10','Cafarena Camila guinda',15,7,12,49,1,'2019-03-11','',24),
(95,'SOIA 11','Maxivestido Catherine verde',15,9,48,79,1,'2019-03-11','WhatsApp Image 2021-09-17 at 11.49.15 PM.jpeg',26),
(96,'SOIA 12','Top Angel fresa',15,4,12,39,1,'2019-03-11','WhatsApp Image 2021-09-17 at 11.45.27 PM.jpeg',26),
(97,'SOIA 14','Top Maia mostaza',15,4,5,15,1,'2019-03-11','',26),
(98,'SOIA 14','Top Flower rosado',15,4,8,29,0,'2019-03-11','IMG_8605.jpg',27),
(100,'SOIA 19','Top Flower verde',15,4,8,29,1,'2019-03-11','IMG_8605.jpg',24),
(101,'SOIA 20','Top Olivia guinda',15,4,20,29,1,'2019-03-11','WhatsApp Image 2021-09-17 at 11.49.04 PM.jpeg',24),
(103,'SOIA 21','Pant rib Mica negro',15,11,17.5,79,0,'2019-03-11','IMG_8551.jpg',24),
(104,'SOIA 21','Pantalon Angel guinda',15,11,12,79,0,'2019-03-11','WhatsApp Image 2021-09-17 at 11.45.16 PM.jpeg',24),
(105,'SOIA 23','Pantalon Angel fresa',15,11,12,79,1,'2019-03-11','WhatsApp Image 2021-09-17 at 11.45.16 PM.jpeg',26),
(106,'SOIA 24','Short Sunny celeste',15,14,7.5,39,0,'2019-03-11','IMG_8624.jpg',27),
(107,'SOIA 26','Ara guinda',15,15,6,35,1,'2019-03-11','IMG_8546.jpg',24),
(108,'SOIA 33','Ara celeste ',15,15,6,35,1,'2019-03-11','IMG_8541.jpg',24),
(109,'SOIA 34','Ara guinda ',15,15,6,35,0,'2019-03-11','',26),
(110,'SOIA 35','Ara mostaza',15,15,6,35,0,'2019-03-11','',24),
(111,'SOIA 36',' Ara azul',15,15,6,35,0,'2019-03-11','IMG_8554.jpg',24),
(112,'SOIA 37 ',' Ara rosado ',15,15,6,35,1,'2019-03-11','',24),
(113,'SOIA 38','Ara negro',15,15,6,35,0,'2019-03-11','155824873_243768487463832_3182202521948664680_n.jpg',27),
(116,'SOIA 51','Palazo rib Bali mostaza',15,11,15,79,1,'2019-03-11','',24),
(118,'SOIA 53','Palazo rib Bali rosado',15,11,15,79,1,'2019-03-11','156543289_243761884131159_8208893164618509794_n.jpg',24),
(124,'SOIA 61','Polo Shocker plomo',15,5,6,19,0,'2019-03-11','',22),
(125,'SOIA 62','Polo Shocker rosado',15,5,6,19,0,'2019-03-11','',22),
(126,'SOIA 64','Top Irma verde',15,4,8,29,0,'2019-03-11','130733389_1155600014885907_4310088866510330534_n.jpg',27),
(127,'SOIA 67','Top Irma menta',15,4,8,29,1,'2019-03-11','130733389_1155600014885907_4310088866510330534_n.jpg',24),
(129,'SOIA 70','Top Irma lacre',15,4,8,29,0,'2019-03-11','130733389_1155600014885907_4310088866510330534_n.jpg',27),
(131,'SOIA 77','Palazo Comfy marron',15,11,18,59,1,'2021-05-18','',24),
(132,'SOIA 80','Polo knit Donna amarillo ',15,5,25,79,0,'2021-05-18','WhatsApp Image 2021-09-17 at 11.44.54 PM.jpeg',24),
(133,'SOIA 81','Polo knit Bella plomo',15,18,23,79,0,'2021-05-18','WhatsApp Image 2021-09-10 at 7.23.00 PM.jpeg',24),
(136,'SOIA 84','Pant Donna negro',15,11,38,79,0,'2021-05-18','WhatsApp Image 2021-09-17 at 11.45.04 PM.jpeg',24),
(137,'SOIA 92','Blusa Tana beige',15,15,18,55,1,'2021-05-18','WhatsApp Image 2021-09-10 at 7.23.00 PM (1).jpeg',24),
(138,'SOIA 93','Falda cuerina Bella negro',15,6,25,69,0,'2021-08-03','WhatsApp Image 2021-09-10 at 7.19.24 PM.jpeg',22),
(139,'SOIA 94','Falda cuerina Bella beige',15,6,25,69,1,'2021-08-03','WhatsApp Image 2021-09-10 at 7.19.24 PM.jpeg',24),
(140,'SOIA 95','Blusa Agnes blanco',15,15,20,69,1,'2021-08-03','WhatsApp Image 2021-09-17 at 11.44.45 PM.jpeg',24),
(141,'SOIA 96','Blusa Agnes lacre',15,15,20,69,0,'2021-08-03','WhatsApp Image 2021-09-17 at 11.44.45 PM.jpeg',24),
(142,'SOIA 97','Blusa Agnes verde cemento',15,15,20,69,0,'2021-08-03','WhatsApp Image 2021-09-17 at 11.44.45 PM.jpeg',24),
(144,'SOIA 99','Blusa Siena fresa',15,15,20,79,1,'2021-08-03','',24),
(145,'SOIA 13','Maxivestido Kathy beige',15,9,45,79,1,'2019-03-11','155912369_243772000796814_5528953533486582326_n.jpg',26),
(146,'SOIA 100','Blusa Lara celeste ',15,15,20,79,0,'2021-08-03','WhatsApp Image 2021-08-17 at 10.44.07 PM.jpeg',24),
(147,'SOIA 101','Blusa Lara jade',15,15,20,79,0,'2021-08-03','WhatsApp Image 2021-08-17 at 10.44.07 PM.jpeg',24),
(148,'SOIA 102','Polo Happy blanco',15,18,16,59,0,'2021-08-26','WhatsApp Image 2021-09-05 at 10.44.09 PM (1).jpeg',24),
(149,'SOIA 103','Polo Happy rosado',15,18,16,59,0,'2021-08-26','WhatsApp Image 2021-09-05 at 10.44.09 PM.jpeg',24),
(150,'SOIA 104 ','One shoulder Happy morado',15,18,16,59,1,'2021-08-26','WhatsApp Image 2021-09-05 at 10.44.09 PM (1).jpeg',24),
(151,'SOIA 105','Blusa Paris marron ',15,15,20,69,0,'2021-08-26','WhatsApp Image 2021-08-31 at 5.45.22 PM.jpeg',24),
(152,'SOIA 106','Blusa Paris lacre',15,15,20,69,1,'2021-08-26','WhatsApp Image 2021-08-31 at 5.45.22 PM.jpeg',24),
(153,'SOIA 107','Blusa Aurora fresa',15,15,17,69,1,'2021-09-04','WhatsApp Image 2021-09-05 at 11.15.39 PM.jpeg',24),
(154,'SOIA 108','Blusa Aurora blanco',15,15,17,69,0,'2021-09-04','WhatsApp Image 2021-09-05 at 11.15.39 PM.jpeg',22),
(155,'SOIA 109','Blusa Aurora beige',15,15,17,69,0,'2021-09-04','WhatsApp Image 2021-09-05 at 11.15.39 PM.jpeg',22),
(156,'SOIA 110','Pant cuerina Barbara guinda',15,11,26,99,0,'2021-09-04','IMG_0919.jpg',24),
(157,'SOIA 111','Pant cuerina Barbara camel',15,11,26,99,1,'2021-09-04','IMG_0910.jpg',24),
(158,'SOIA 112','Pant cuerina Barbara negro',15,11,26,99,0,'2021-09-04','IMG_0867.jpg',22),
(159,'SOIA 113','Pant cuerina Barbara rosado',15,11,26,99,0,'2021-09-04','IMG_0882.jpg',22),
(160,'SOIA 114','Blusa Leah verde',15,15,20,69,0,'2021-09-05','IMG_0910.jpg',22),
(161,'SOIA 115','Blusa Leah negro',15,15,20,69,1,'2021-09-05','IMG_0917.jpg',24),
(162,'SOIA 116','Polo crop Didi cebra',15,18,16,59,1,'2021-09-04','IMG_0870.jpg',24),
(163,'SOIA 117','Polo crop Didi print leon',15,18,16,59,1,'2021-09-05','IMG_0877.jpg',24),
(164,'SOIA 118','Polo crop Didi print happy',15,18,16,59,1,'2021-09-04','IMG_0867.jpg',24),
(165,'SOIA 119','Polo Chloe cebra',15,5,13,59,1,'2021-09-04','IMG_0882.jpg',24),
(166,'SOIA 120','Polo Chloe beige',15,5,13,59,0,'2021-09-04','WhatsApp Image 2021-09-06 at 12.28.17 AM.jpeg',24),
(167,'SOIA 121','Polo Chloe rosado',15,5,13,59,1,'2021-09-04','IMG_0884.jpg',24),
(168,'SOIA 122','Top rib Tiara lila',15,4,10,49,1,'2021-08-30','WhatsApp Image 2021-09-05 at 11.10.51 PM.jpeg',22),
(169,'SOIA 123','Top rib Tiara blanco',15,4,10,49,0,'2021-08-30','WhatsApp Image 2021-09-05 at 11.12.59 PM (1).jpeg',22),
(170,'SOIA 124','Top rib Tiara negro',15,4,10,49,1,'2021-08-30','WhatsApp Image 2021-09-10 at 6.38.00 PM.jpeg',22),
(171,'SOIA 125','Top rib Tiara rosado',15,4,10,49,0,'2021-08-30','WhatsApp Image 2021-09-10 at 6.39.44 PM.jpeg',22),
(172,'SOIA 126','Top rib Tiara celeste',15,4,10,49,0,'2021-08-30','WhatsApp Image 2021-09-05 at 11.11.17 PM.jpeg',23),
(173,'SOIA 127','Top rib Tiara morado',15,4,10,49,0,'2021-08-30','WhatsApp Image 2021-09-05 at 11.10.51 PM.jpeg',23),
(174,'SOIA 128 ','Blusa Lucia negro',15,15,10,59,1,'2021-08-30','IMG_0900.jpg',22),
(175,'SOIA 129','Blusa Lucia verde',15,15,10,59,0,'2021-08-30','WhatsApp Image 2021-09-05 at 11.07.22 PM.jpeg',22),
(176,'SOIA 130','Blusa Lucia beige',15,15,10,59,0,'2021-08-30','WhatsApp Image 2021-09-05 at 11.07.50 PM.jpeg',22),
(177,'SOIA 131','Blusa lucia negro',15,15,10,59,0,'2021-08-30','WhatsApp Image 2021-09-05 at 11.07.17 PM.jpeg',22),
(178,'SOIA 132','Blusa Lucia verde',15,15,10,59,1,'2021-08-30','WhatsApp Image 2021-09-05 at 11.07.22 PM.jpeg',22),
(179,'SOIA 133','Blusa Lucia beige',15,15,10,59,0,'2021-08-30','WhatsApp Image 2021-09-05 at 11.07.50 PM.jpeg',22),
(181,'SOIA 134','Top crop Paula cebra',15,18,14,59,1,'2021-09-06','WhatsApp Image 2021-09-08 at 4.44.59 PM.jpeg',24),
(182,'SOIA 135','Top crop Paula beige',15,18,14,59,1,'2021-09-06','WhatsApp Image 2021-09-08 at 4.44.59 PM.jpeg',24),
(183,'SOIA 136','Top crop Paula happy rosado',15,18,14,59,1,'2021-09-06','WhatsApp Image 2021-09-08 at 4.44.59 PM.jpeg',24),
(184,'SOIA 137','Blusa Elena lacre',15,15,20,69,1,'2021-09-08','IMG_0936.jpg',24),
(185,'SOIA 138','Blusa Elena celeste',15,15,20,69,0,'2021-09-08','IMG_0941.jpg',24),
(186,'SOIA 139','Blusa Elena beige',15,15,20,69,0,'2021-09-08','IMG_0941.jpg',24),
(187,'SOIA 140','Blusa Marbella melon ',15,15,15,59,0,'2021-09-12','WhatsApp Image 2021-09-18 at 12.59.18 AM.jpeg',27),
(188,'SOIA 141','Blusa Marbella beige',15,15,15,59,0,'2021-09-12','WhatsApp Image 2021-09-18 at 12.59.18 AM.jpeg',27),
(189,'SOIA 142','Polo crop RACHEL verde',15,18,17,59,1,'2021-09-12','WhatsApp Image 2021-09-17 at 5.07.18 PM.jpeg',26),
(190,'SOIA 143','Polo crop Rachel beige',15,18,17,59,1,'2021-09-12','WhatsApp Image 2021-09-17 at 5.07.18 PM.jpeg',26),
(191,'SOIA 144','Polo crop Rachel rosado',15,18,17,59,1,'2021-09-12','WhatsApp Image 2021-09-17 at 5.07.18 PM.jpeg',26),
(192,'SOIA 145','Pant Paula cebra (white)',15,11,23,99,0,'2021-09-17','WhatsApp Image 2021-09-15 at 8.48.44 PM.jpeg',27),
(193,'SOIA 146','Pant Paula cebra (beige)',15,11,23,79,0,'2021-09-17','WhatsApp Image 2021-09-15 at 8.48.44 PM.jpeg',26),
(194,'SOIA 147','Pant Paula cebra (lacre)',15,11,23,99,0,'2021-09-17','WhatsApp Image 2021-09-15 at 8.48.44 PM.jpeg',27),
(195,'SOIA 148','Top crop Dana cebra',15,4,14,49,0,'2021-09-17','',27),
(196,'SOIA 149','Top Dana print',15,4,14,49,0,'2021-09-17','',27),
(197,'SOIA 150','Top Dana happy',15,4,14,49,0,'2021-09-17','',27),
(198,'asdasd','adsdas',13,19,1,2,1,'2021-09-16','',25),
(199,'SOIA 39','BLUSA NEA VERDE',15,15,28,20,0,'2021-09-26','',27),
(201,'PRUEBA','PRUEBA',13,19,1,1,1,'1995-10-12','',25),
(203,'SOIA 56','Top Gamuza verde',15,4,6,19,0,'2021-09-01','',24),
(204,'SOIA 57 ','Top Gamuza guinda',15,4,6,19,0,'2021-09-01','',24),
(205,'SOIA 58','TOP VANIA BLANCO',15,4,6,19,0,'2021-09-01','',24),
(206,'SOIA 59','Polo Malu negro',15,5,6,19,0,'2021-09-01','',24),
(207,'SOIA 68','Top Irma rosa chicle',15,4,8,29,0,'2021-09-01','',24),
(208,'SOIA 74','Cafarena Alura plomo',15,7,24,49,0,'2021-09-05','',22),
(209,'SOIA 98','Blusa Siena Beige',15,15,20,79,0,'2021-09-05','',22),
(210,'SOIA 82','Polo knit Bella celeste',15,18,23,79,0,'2021-09-05','',22),
(211,'SOIA 83','Polo knit Bella verde',15,18,23,79,0,'2021-09-05','',22),
(212,'GAL 01','Top Alba rosa ',16,20,8,19.9,1,'2021-05-05','',28),
(213,'GAL 02','Top Alba negro',16,20,8,19.9,1,'2021-05-05','',28),
(214,'GAL 03','Top Alba azul',16,20,8,19.9,1,'2021-05-05','',28),
(215,'GAL 04','Top Alba azul',16,20,8,19.9,1,'2021-05-05','',28),
(216,'GAL 05','Top Alba guinda',16,20,8,19.9,1,'2021-05-05','',28),
(217,'GAL 06','Top Alba negro',16,20,8,19.9,1,'2021-05-05','',28),
(218,'GAL 07','Top Adel blanco',16,20,8,19.9,1,'2021-05-05','',28);
...
(13,'yeshuah','gutierrez','yeshuahg.s@hotmail.com','12345','clientes'),
(14,'Lucia','Carrion','lu18_04@hotmail.com','12345','admin'),
(15,'SOIA','THE BRAND','hola-soia@hotmail.com','metodicamente95','clientes'),
(16,'GALENA','PERU','rosemakeupstore@hotmail.com','metodicamente95','clientes'),
(17,'GALENA','PERU','holaminimalcloset@gmail.com','metodicamente95','clientes');
...
CREATE TABLE `categorias` (
  ...
  CONSTRAINT `fk_categoria_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`id`)
) ENGINE=INNODB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4;

/*Data for the table `categorias` */

INSERT  INTO `categorias`(`id`,`usuario`,`nombre`) VALUES 
(4,15,'TOP'),
(5,15,'POLOS'),
(6,15,'FALDAS'),
(7,15,'CAFARENAS'),
...
CREATE TABLE `lineas_pedidos` (
  ...
  `multimarca_id` INT(11) NOT NULL,
  `unidades` INT(11) DEFAULT NULL,
  `descuento` FLOAT DEFAULT NULL,
  `comision` FLOAT DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_multimarca` (`multimarca_id`),
  KEY `FK_pedido` (`pedido_id`),
  KEY `FK_producto` (`producto_id`),
  CONSTRAINT `FK_multimarca` FOREIGN KEY (`multimarca_id`) REFERENCES `multimarca` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_pedido` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_producto` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=INNODB AUTO_INCREMENT=209 DEFAULT CHARSET=utf8mb4;

/*Data for the table `lineas_pedidos` */

INSERT  INTO `lineas_pedidos`(`id`,`pedido_id`,`producto_id`,`multimarca_id`,`unidades`,`descuento`,`comision`) VALUES 
(133,131,149,24,1,0,30),
(135,131,148,24,1,0,30),
(136,132,124,23,1,0,20),
(137,132,125,23,1,0,20),
(141,136,204,24,1,0,30),
(142,136,203,24,1,0,30),
(143,136,205,24,1,0,30),
(144,136,206,24,1,0,30),
(145,136,207,24,1,0,30),
(146,137,208,22,1,14,25),
(147,137,209,22,1,9,25),
(148,137,210,22,1,21,25),
(149,137,211,22,1,21,25),
(163,141,192,27,1,54,0),
(164,141,194,27,1,54,0),
(165,141,195,27,1,34,0),
(166,141,196,27,1,34,0),
(167,141,197,27,1,34,0),
(168,141,187,27,1,39,0),
(169,141,188,27,1,39,0),
(170,141,126,27,1,19,0),
(171,141,129,27,1,19,0),
(172,141,113,27,1,25,0),
(173,141,199,27,1,0,0),
(174,141,106,27,1,29,0),
(175,142,141,24,1,0,30),
(176,143,158,22,1,9,25),
(177,143,159,22,1,9,25),
(178,143,160,22,1,10,25),
(179,143,155,22,1,10,25),
(180,144,104,27,1,59,0),
(181,144,103,27,1,59,0),
(182,144,98,27,1,14,0),
(183,145,147,24,1,0,30),
(184,145,146,24,1,0,30),
(185,145,142,24,1,0,30),
(186,146,132,24,1,0,30),
(187,146,133,24,1,0,30),
(188,146,151,24,1,20,30),
(189,147,154,22,1,20,25),
(190,147,138,22,1,20,25),
(191,148,110,24,1,10,30),
(192,149,141,24,1,0,30),
(193,150,172,23,1,14,20),
(194,150,173,23,1,14,20),
(195,151,177,22,1,0,25),
(196,151,171,22,1,0,25),
(197,151,176,22,1,0,25),
(198,151,175,22,1,17,25),
(199,151,179,22,1,17,25),
(200,151,169,22,1,14,25),
(201,152,186,24,1,20,30),
(202,152,156,24,1,29,30),
(203,152,166,24,1,17,30),
(204,152,185,24,1,20,30),
(205,152,136,24,1,10,30),
(206,153,111,24,1,0,30),
(207,154,109,26,1,0,30),
(208,154,193,26,1,23,30);
