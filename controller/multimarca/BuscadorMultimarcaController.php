...
if (isset($_POST['data'])) {
    $_SESSION['datoMultimarca'] = $_POST['data'];
} else {
    $_SESSION['datoMultimarca'] = null;
}
$buscadorCount = MultimarcaModelo::CountBuscadorMultimarca($_SESSION['datoMultimarca']);
...
$buscador = MultimarcaModelo::BuscadorMultimarca($_SESSION['datoMultimarca'], $desde, $por_pagina);
if ($_POST['data'] != "") :
    if (COUNT($buscador) > 0) :
?>
        <br>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center ">
                        <li class="page-item-multimarca">
                            <a class="page-link-multimarcaBuscador" page="<?= ($pagina - 1) ?>" href="#">
                        ...
                        ?>
                            <li class="page-item-multimarca <?= $clase_activa ?>">
                                <a class="page-link-multimarcaBuscador" page='<?= $i ?>' href="#"><?= $i ?></a>
                            </li>
                        <?php }
                        if ($pagina < $total_paginas) {
                            $pagina++; ?>
                            <li class="page-item-multimarca"><a class="page-link-multimarcaBuscador" page='<?= $pagina ?>' href="#"><i class="fas fa-caret-right"></i></a></li>
                        <?php } ?>
                    </ul>
                </nav>
            </div>
