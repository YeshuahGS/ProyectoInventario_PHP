...
if (isset($_SESSION['datoMultimarca'])) {
    $data = $_SESSION['datoMultimarca'];
} else {
    $data = null;
}
$buscadorCount = MultimarcaModelo::CountBuscadorMultimarca($data);
...
$buscador = MultimarcaModelo::BuscadorMultimarca($data, $desde, $por_pagina);

if ($_SESSION['datoMultimarca'] != "") :
if (COUNT($buscador) > 0) :
?>
    <br>
