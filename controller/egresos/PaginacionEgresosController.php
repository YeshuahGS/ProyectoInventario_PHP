...
if (isset($_SESSION['busquedaEgresos'])) {
    $data = $_SESSION['busquedaEgresos'];
} else {
    $data = null;
}
$buscadorCount = egresosModelo::CountBuscadorEgresos($data);
...
$totalGasto = null;
$egresos = egresosModelo::BuscadorEgresos($data, $desde, $por_pagina);
$egresosTotal = egresosModelo::BuscadorEgresosTotal($data);
