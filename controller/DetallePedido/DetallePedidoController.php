...
$_SESSION['idDetallePedidos'] = $_POST['id'];

$countDetalle = pedidosModelo::CountVerDetallePedidosModelo($_SESSION['idDetallePedidos'] );
...
$detalle = pedidosModelo::VerDetallePedidosModelo($_SESSION['idDetallePedidos'] , $desde, $por_pagina);
if (COUNT($detalle) > 0) : ?>
        ...
        <div class="col-lg-12 text-center my-4">
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center ">
                    <li class="page-item-LineaPedido">
                    ...
                    ?>
                        <li class="page-item-LineaPedido <?= $clase_activa ?>">
                            <a class="page-link-LineaPedido" page='<?= $i ?>' href="#"><?= $i ?></a>
                        </li>
                    <?php }
                    if ($pagina < $total_paginas) {
                        $pagina++; ?>
                        <li class="page-item-LineaPedido"><a class="page-link-LineaPedido" page='<?= $pagina ?>' href="#"><i class="fas fa-caret-right"></i></a></li>
                    <?php } ?>
                </ul>
            </nav>
        </div>
