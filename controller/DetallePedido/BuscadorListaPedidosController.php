...
if (isset($_POST['data'])) {
    $_SESSION['busquedaDetallePedido']  = $_POST['data'];
} else {
    $_SESSION['busquedaDetallePedido']  = null;
}
$CountPedidos = pedidosModelo::BuscadorCountListaPedido($_SESSION['busquedaDetallePedido']);
...
$buscador = pedidosModelo::BuscadorListaPedido($desde, $por_pagina, $_SESSION['busquedaDetallePedido']);
$total = 0;
...
if ($_SESSION['busquedaDetallePedido'] != "") :
